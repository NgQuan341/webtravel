                ...
                <div class="col-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        ...
                        <table class="table">
                            ...
                            $acc = new Accounts();
                            $tour = new Tours();
                            $result=$book->action->display($book->tablename);
                            while($row=$result->fetch_assoc()){
                                $result1=$acc->action->displayOne($acc->tablename,$acc->col_id,$row['id_acc']);
                                $result2=$tour->action->displayOne($tour->tablename,$tour->col_id,$row['id_tour']);
