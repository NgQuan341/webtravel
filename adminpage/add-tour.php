                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            ...
                            <div class="form-group mb-3">
                                    <label for="name_tour">Tour Name</label>
                                    <input id="name_tour" name="name_tour" type="text" class="form-control validate" required />
                            </div>

                            <div class="form-group mb-3">
                                <label for="description">Description</label>
                                <textarea class="form-control validate" rows="3" id="description" name="description" required></textarea>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                    ...
                                    <input id="time" name="time" type="text" value="" class="form-control validate" />
                                </div>
